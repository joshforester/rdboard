 ...
 *  Date: 04/30/05
 *  Description: This program generates javabean code given
...
public class Beanmaker {
	...
	try {
      ...
      String dateString =
          new String((cal.get(Calendar.MONTH) + 1) + "/" +
                     cal.get(Calendar.DATE) + "/" +
                     cal.get(Calendar.YEAR));

      // Write comments.
      out.write("/**\n");
      out.write(" *  File: " + file.getName() + ".java\n");
      out.write(" *  Author:  Joshua Forester\n");
      out.write(" *  Date: " + dateString + "\n");
      out.write(" *  Description: Bean class for " + file.getName() + " object.\n");
      out.write(" **/\n\n\n");
